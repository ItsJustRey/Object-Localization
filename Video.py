...
class Video:
    def __init__(self, id):
        try:
            ...
            self.red_xyz_pts =    {'x': None, 'y': None, 'z': None, 'pts': self.newDeque}
            self.green_xyz_pts =  {'x': None, 'y': None, 'z': None, 'pts': self.newDeque}
            self.blue_xyz_pts =   {'x': None, 'y': None, 'z': None, 'pts': self.newDeque}
